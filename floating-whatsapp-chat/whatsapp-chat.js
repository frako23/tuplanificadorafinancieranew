        ...
        if(settings.selector != ''){
            ...
            if(element !=null){
                var chatBox = '<div class="ayoan_whatsapp_chatbox_container">' +
                    ...
                    '<div class="header-title">Conversemos</div><div class="header-content">'+settings.headerMessage+
...
function sendWPMessage(phone, message=''){
    ...
    var apiEndPoint = 'https://api.whatsapp.com/send?phone=+';

    apiEndPoint = apiEndPoint+phone;
